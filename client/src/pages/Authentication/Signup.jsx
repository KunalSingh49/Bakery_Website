...
export default function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    // ✅ Check if role is admin, validate security code
    if (role === "admin" && securityCode !== "shrutiAdmin123") {
      setSecurityError("Invalid security code for Admin registration.");
      return;
    }
      ...
      <Container maxWidth="xs" sx={{ position: "relative" }}>
        ...
        >
          ...
          <Box component="form" noValidate onSubmit={handleSubmit}>
            ...
            {/* Show Security Code only if Admin is selected */}
            {role === "admin" && (
              <TextField
                required
                fullWidth
